...
export const About = () => {
  return (
    <>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2500">
                    <div className='bg-white h-96'>
                      <h1 className='text-black text-5xl text-center py-28'>THINK BEYOND </h1>
                      <p className='text-center'>Go further thah the conventional thoughts.</p>
                    </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="2500">
                    <div className='bg-white h-80'>
                      <h1 className='text-black text-5xl text-center py-28'>GET INSPIRED </h1>
                      <p className='text-center'>Let's create something.</p>
                    </div>
                  </div>
      ...
      <br />
      <h2 className='text-pink-600 xs:text-4xl lg:text-6xl  text-center'>OUR PROJECTS</h2>
      <br />
      <br />
