  ...
  return (
    ...
    <NavBar/>
      ...
      <div className=" bg-gray-200 flex w-full h-96">
        <div className=" class w-3/6 grid place-items-center md:w-full " >
        ...
        <div className=" class w-3/6  px-7">
          ...
          <form class="w-full">
            ...
            <div class="w-full ">
              <label class="block text-gray-900 font-bold text-2xl py-2 " for="inline-full-name">Name</label>
              <input class="bg-gray-50 w-full   h-14  py-2 px-4 text-gray-700 leading-tight " id="name" type="text" placeholder='Name' />
              <label class="block text-gray-900 font-bold text-2xl py-2" for="inline-mail">Email</label>
              <input class="bg-gray-50 w-full h-14  py-2 px-4 border-gray-200  text-gray-700 leading-tight focus:outline-none focus:bg-white " id="inline-password" type="email" placeholder="Email" />
              <label class="block text-gray-900 font-bold text-2xl py-2" for="inline-full-name">How can we help you?</label>
              <select class="block appearance-none w-full h-14 bg-gray-50  border-gray-200 text-gray-700 py-3 px-4  leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
